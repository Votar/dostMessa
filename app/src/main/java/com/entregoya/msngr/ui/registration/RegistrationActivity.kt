...
import com.entregoya.msngr.ui.registration.presenter.IRegistrationPresenter
import com.entregoya.msngr.ui.registration.presenter.RegistrationPresenter
...
class RegistrationActivity : AppCompatActivity(), IRegistrationView {
    ...
    override fun getContext(): Context = RegistrationActivity@ this

    override fun setErrorEmailRegistered() {
        registration_edit_email.requestFocus()
        registration_il_email.error = getString(R.string.registered_field)
    }
